...
import time
import datetime
from strategy_logic_simple_mean_reversion import StrategyLogicSimpleMeanReversion
...
class Strategy(goxapi.BaseObject):
    ...
    def __init__(self, gox):
        ...
        self.strategy_logic = StrategyLogicSimpleMeanReversion(self.exchangeConnection)
