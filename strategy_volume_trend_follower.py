...
import time
import datetime
from strategy_core_volume_trend_follower import VolumeTrendFollowerStrategyCore
...
class Strategy(goxapi.BaseObject):
    ...
    def __init__(self, gox):
        ...
        self.score = VolumeTrendFollowerStrategyCore(self.exchangeConnection)
        self.score.Load()
