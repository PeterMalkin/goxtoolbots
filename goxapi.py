...
class GoxConfig(SafeConfigParser):
    ...
    _DEFAULTS = [["gox", "base_currency", "BTC"]
                ...
                ,["gox", "secret_key", ""]
                ,["gox", "secret_secret", ""]
                ,["email", "email_to", "mtgoxtrader@example.com"]
                ,["email", "email_from", "tradingbot@example.com"]
                ,["email", "email_server", "smtp.example.com"]
                ,["email", "email_server_port", "25"]
                ,["email", "email_server_password", "TradingBotEmailPassword"]
                ]
